...
const DeliveredParcel = async (req: Request, res: Response) => {
  try {
    const id: string = req.params.id;
    const user: any = req.user;
    console.log(id);
    ...
    const parcel = await ParcelService.DeliveredParcel(id, user.userId);
...
const GetReceiverDeliveredParcel = async (req: Request, res: Response) => {
  try {
    const user: any = req.user;
    const parcel = await ParcelService.GetReceiverDeliveredParcel(user.userId);
